...
\documentclass[openany, oneside, parskip=full, 12pt, a4]{scrbook}
...
\input{abstracts/tex/AllAbstracts}
...
%------------------------------------------------------------------
\clearpage
\section{Partner Institutions and Sponsors}
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.95\linewidth]{Sponsors/SponsorsPage}
%	\caption{}
%	\label{fig:sponsorspage}
\end{figure}


%\includepdf{PESGRE_AllSponsors.pdf}
%\input{logos.tex}
